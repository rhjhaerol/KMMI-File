...
$query="INSERT INTO matkul VALUES ('$kode_matkul','$nama_matkul','$jml_sks','$kode_jurusan')";
  ...
  <body>
        <div class="mx-auto p-5" style="width: 600px;">
            ...
            <div class="form-group mb-4">
                ...
                <input class="form-control font-weight-medium" placeholder="Masukan Kode Matkul" name="kode_matkul" type="text" id="kode_matkul">
            </div>
            <div class="form-group mb-4">
                <label for="" class="control-label">Nama Matkul</label>
                <input class="form-control font-weight-medium" placeholder="Masukan Nama Matkul" name="nama_matkul" type="text" id="nama_matkul">
            </div>
            <div class="form-group mb-4">
                <label for="" class="control-label">Jumlah SKS</label>
                <input class="form-control font-weight-medium" placeholder="Masukan Jumlah SKS" name="jml_sks" type="text" id="jml_sks">
            </div>
            <div class="form-group mb-4">
